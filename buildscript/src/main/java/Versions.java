public class Versions {
    ...
    public static final String FABRIC_LOADER_VERSION = "0.14.10";
    public static final int JAVA_VERSION = 17;
    public static final String QUILTFLOWER_VERSION = "1.9.0";
    public static final String FABRIC_GAMERULE_API_VERSION = "1.0.22+c6af733c90";
    public static final String CAFFEINE_CONFIG_VERSION = "1.0.0";
    public static final String LAZYDFU_VERSION = "0.1.3";
    public static final String MIXIN_EXTRAS_VERSION = "0.1.1-rc.4";
    public static final String CONDITIONAL_MIXIN_VERSION = "v0.3.1";
}
