...
public class PopulateMaps implements Maps {
    public static void populateMaps() {
        ...
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.ALBAN), ALBAN_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.AZTEC2), AZTEC2_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.AZTEC), AZTEC_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.BOMB), BOMB_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.BURNING_SKULL), BURNING_SKULL_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.BUST), BUST_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.COURBET), COURBET_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.CREEBET), CREEBET_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.DONKEY_KONG), DONKEY_KONG_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.EARTH), EARTH_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.FIGHTERS), FIGHTERS_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.FIRE), FIRE_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.GRAHAM), GRAHAM_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.KEBAB), KEBAB_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.MATCH), MATCH_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.PIGSCENE), PIGSCENE_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.PLANT), PLANT_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.POINTER), POINTER_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.POOL), POOL_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.SEA), SEA_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.SKELETON), SKELETON_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.SKULL_AND_ROSES), SKULL_AND_ROSES_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.STAGE), STAGE_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.SUNSET), SUNSET_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.VOID), VOID_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.WANDERER), WANDERER_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.WASTELAND), WASTELAND_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.WATER), WATER_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.WIND), WIND_PAINTING);
        paintingHolderPaintingVariantMap.put(BuiltInRegistries.PAINTING_VARIANT.getHolderOrThrow(PaintingVariants.WITHER), WITHER_PAINTING);
