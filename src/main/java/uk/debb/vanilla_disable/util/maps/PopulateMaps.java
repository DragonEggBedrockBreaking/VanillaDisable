...
public class PopulateMaps implements Maps {
    public static void populateMaps() {
        ...
        itemStackClassMap.put(BoatItem.class, BOATS_ENABLED);
        itemStackClassMap.put(BottleItem.class, BOTTLES_ENABLED);
        itemStackClassMap.put(BowItem.class, BOWS_ENABLED);
        itemStackClassMap.put(BucketItem.class, BUCKETS_ENABLED);
        itemStackClassMap.put(BundleItem.class, BUNDLES_ENABLED);
        itemStackClassMap.put(CrossbowItem.class, CROSSBOWS_ENABLED);
        itemStackClassMap.put(EggItem.class, EGGS_ENABLED);
        itemStackClassMap.put(EmptyMapItem.class, MAPS_ENABLED);
        itemStackClassMap.put(EnderEyeItem.class, ENDER_EYES_ENABLED);
        itemStackClassMap.put(EnderpearlItem.class, ENDER_PEARLS_ENABLED);
        itemStackClassMap.put(ExperienceBottleItem.class, EXPERIENCE_BOTTLES_ENABLED);
        itemStackClassMap.put(FireworkRocketItem.class, FIREWORKS_ENABLED);
        itemStackClassMap.put(FishingRodItem.class, FISHING_ENABLED);
        itemStackClassMap.put(FoodOnAStickItem.class, FOOD_ON_STICKS_ENABLED);
        itemStackClassMap.put(InstrumentItem.class, GOAT_HORNS_ENABLED);
        itemStackClassMap.put(KnowledgeBookItem.class, BOOKS_ENABLED);
        itemStackClassMap.put(ShieldItem.class, SHIELDS_ENABLED);
        itemStackClassMap.put(SnowballItem.class, SNOWBALLS_ENABLED);
        itemStackClassMap.put(SpyglassItem.class, SPYGLASSES_ENABLED);
        itemStackClassMap.put(TridentItem.class, TRIDENTS_ENABLED);
        itemStackClassMap.put(WritableBookItem.class, BOOKS_ENABLED);
        itemStackClassMap.put(WrittenBookItem.class, BOOKS_ENABLED);
        itemStackClassMap.put(AxeItem.class, AXES_ENABLED);
        itemStackClassMap.put(BoneMealItem.class, BONE_MEAL_ENABLED);
        itemStackClassMap.put(CompassItem.class, COMPASSES_ENABLED);
        itemStackClassMap.put(EndCrystalItem.class, END_CRYSTALS_ENABLED);
        itemStackClassMap.put(FireChargeItem.class, FIRE_CHARGES_ENABLED);
        itemStackClassMap.put(FlintAndSteelItem.class, FLINT_AND_STEEL_ENABLED);
        itemStackClassMap.put(HangingEntityItem.class, HANGING_ENTITIES_ENABLED);
        itemStackClassMap.put(HoeItem.class, HOES_ENABLED);
        itemStackClassMap.put(HoneycombItem.class, HONEYCOMBS_ENABLED);
        itemStackClassMap.put(LeadItem.class, LEADS_ENABLED);
        itemStackClassMap.put(MapItem.class, MAPS_ENABLED);
        itemStackClassMap.put(MinecartItem.class, MINECARTS_ENABLED);
        itemStackClassMap.put(RecordItem.class, RECORDS_ENABLED);
        itemStackClassMap.put(ShearsItem.class, SHEARS_ENABLED);
        itemStackClassMap.put(ShovelItem.class, SHOVELS_ENABLED);
        itemStackClassMap.put(SolidBucketItem.class, BUCKETS_ENABLED);
        itemStackClassMap.put(DyeItem.class, DYES_ENABLED);
        itemStackClassMap.put(NameTagItem.class, NAMETAGS_ENABLED);
        itemStackClassMap.put(SaddleItem.class, SADDLES_ENABLED);
        itemStackClassMap.put(ChorusFruitItem.class, CHORUS_FRUIT_EFFECTS_ENABLED);
        itemStackClassMap.put(HoneyBottleItem.class, HONEY_BOTTLE_EFFECTS_ENABLED);
        itemStackClassMap.put(MilkBucketItem.class, MILK_BUCKET_EFFECTS_ENABLED);
        itemStackClassMap.put(SuspiciousStewItem.class, SUSPICIOUS_STEW_EFFECTS_ENABLED);
        ...
        foodDataFoodPropertiesMapSaturation.put(Foods.APPLE, APPLE_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.BAKED_POTATO, BAKED_POTATO_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.BEEF, BEEF_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.BEETROOT, BEETROOT_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.BEETROOT_SOUP, BEETROOT_SOUP_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.BREAD, BREAD_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.CARROT, CARROT_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.CHICKEN, CHICKEN_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.CHORUS_FRUIT, CHORUS_FRUIT_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.COD, COD_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.COOKED_BEEF, COOKED_BEEF_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.COOKED_CHICKEN, COOKED_CHICKEN_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.COOKED_COD, COOKED_COD_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.COOKED_MUTTON, COOKED_MUTTON_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.COOKED_PORKCHOP, COOKED_PORKCHOP_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.COOKED_RABBIT, COOKED_RABBIT_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.COOKED_SALMON, COOKED_SALMON_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.COOKIE, COOKIE_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.DRIED_KELP, DRIED_KELP_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.ENCHANTED_GOLDEN_APPLE, ENCHANTED_GOLDEN_APPLE_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.GOLDEN_APPLE, GOLDEN_APPLE_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.GOLDEN_CARROT, GOLDEN_CARROT_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.HONEY_BOTTLE, HONEY_BOTTLE_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.MELON_SLICE, MELON_SLICE_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.MUSHROOM_STEW, MUSHROOM_STEW_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.MUTTON, MUTTON_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.POISONOUS_POTATO, POISONOUS_POTATO_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.PORKCHOP, PORKCHOP_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.POTATO, POTATO_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.PUFFERFISH, PUFFERFISH_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.PUMPKIN_PIE, PUMPKIN_PIE_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.RABBIT, RABBIT_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.RABBIT_STEW, RABBIT_STEW_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.ROTTEN_FLESH, ROTTEN_FLESH_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.SALMON, SALMON_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.SPIDER_EYE, SPIDER_EYE_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.SUSPICIOUS_STEW, SUSPICIOUS_STEW_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.SWEET_BERRIES, SWEET_BERRIES_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.GLOW_BERRIES, GLOW_BERRIES_SATURATION);
        foodDataFoodPropertiesMapSaturation.put(Foods.TROPICAL_FISH, TROPICAL_FISH_SATURATION);
