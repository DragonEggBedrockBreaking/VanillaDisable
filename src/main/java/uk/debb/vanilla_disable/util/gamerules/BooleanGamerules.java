...
public enum BooleanGamerules {
    ...
    TIPPED_ARROWS_ENABLED(VD_DISPENSER, true),
    FIRE_RESISTANCE_TIPPED_ARROW(VD_DISPENSER, true),
    HARMING_TIPPED_ARROW(VD_DISPENSER, true),
    HEALING_TIPPED_ARROW(VD_DISPENSER, true),
    INVISIBILITY_TIPPED_ARROW(VD_DISPENSER, true),
    LEAPING_TIPPED_ARROW(VD_DISPENSER, true),
    LUCK_TIPPED_ARROW(VD_DISPENSER, true),
    NIGHT_VISION_TIPPED_ARROW(VD_DISPENSER, true),
    POISON_TIPPED_ARROW(VD_DISPENSER, true),
    REGENERATION_TIPPED_ARROW(VD_DISPENSER, true),
    SLOWNESS_TIPPED_ARROW(VD_DISPENSER, true),
    SLOW_FALLING_TIPPED_ARROW(VD_DISPENSER, true),
    STRENGTH_TIPPED_ARROW(VD_DISPENSER, true),
    SWIFTNESS_TIPPED_ARROW(VD_DISPENSER, true),
    TURTLE_MASTER_TIPPED_ARROW(VD_DISPENSER, true),
    WATER_BREATHING_TIPPED_ARROW(VD_DISPENSER, true),
    WEAKNESS_TIPPED_ARROW(VD_DISPENSER, true),
    SPECTRAL_ARROWS_ENABLED(VD_DISPENSER, true),
