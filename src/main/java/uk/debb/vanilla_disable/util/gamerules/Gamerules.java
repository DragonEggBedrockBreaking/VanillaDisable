...
public enum Gamerules {
    ...
    DEBUG_COMMAND(VD_COMMANDS, true),
    DEFAULT_GAMEMODE_COMMAND(VD_COMMANDS, true),
    ...
    WARDEN_SPAWN_TRACKER_COMMAND(VD_COMMANDS, true),
    ...
    PLAYER_FLYING_SPEED(VD_PLAYER, 0.05),
    ...
    BIOMES_ENABLED(VD_BIOME, true),
    BADLANDS_BIOME(VD_BIOME, true),
    BAMBOO_JUNGLE_BIOME(VD_BIOME, true),
    BEACH_BIOME(VD_BIOME, true),
    BIRCH_FOREST_BIOME(VD_BIOME, true),
    COLD_OCEAN_BIOME(VD_BIOME, true),
    DARK_FOREST_BIOME(VD_BIOME, true),
    DEEP_COLD_OCEAN_BIOME(VD_BIOME, true),
    DEEP_DARK_BIOME(VD_BIOME, true),
    DEEP_FROZEN_OCEAN_BIOME(VD_BIOME, true),
    DEEP_LUKEWARM_OCEAN_BIOME(VD_BIOME, true),
    DEEP_OCEAN_BIOME(VD_BIOME, true),
    DESERT_BIOME(VD_BIOME, true),
    DRIPSTONE_CAVES_BIOME(VD_BIOME, true),
    ERODED_BADLANDS_BIOME(VD_BIOME, true),
    FLOWER_FOREST_BIOME(VD_BIOME, true),
    FOREST_BIOME(VD_BIOME, true),
    FROZEN_OCEAN_BIOME(VD_BIOME, true),
    FROZEN_PEAKS_BIOME(VD_BIOME, true),
    FROZEN_RIVER_BIOME(VD_BIOME, true),
    GROVE_BIOME(VD_BIOME, true),
    ICE_SPIKES_BIOME(VD_BIOME, true),
    JAGGED_PEAKS_BIOME(VD_BIOME, true),
    JUNGLE_BIOME(VD_BIOME, true),
    LUKEWARM_OCEAN_BIOME(VD_BIOME, true),
    LUSH_CAVES_BIOME(VD_BIOME, true),
    MANGROVE_SWAMP_BIOME(VD_BIOME, true),
    MEADOW_BIOME(VD_BIOME, true),
    MUSHROOM_FIELDS_BIOME(VD_BIOME, true),
    OCEAN_BIOME(VD_BIOME, true),
    OLD_GROWTH_BIRCH_FOREST_BIOME(VD_BIOME, true),
    OLD_GROWTH_PINE_TAIGA_BIOME(VD_BIOME, true),
    OLD_GROWTH_SPRUCE_TAIGA_BIOME(VD_BIOME, true),
    RIVER_BIOME(VD_BIOME, true),
    SAVANNA_BIOME(VD_BIOME, true),
    SAVANNA_PLATEAU_BIOME(VD_BIOME, true),
    SNOWY_BEACH_BIOME(VD_BIOME, true),
    SNOWY_PLAINS_BIOME(VD_BIOME, true),
    SNOWY_SLOPES_BIOME(VD_BIOME, true),
    SNOWY_TAIGA_BIOME(VD_BIOME, true),
    SPARSE_JUNGLE_BIOME(VD_BIOME, true),
    STONY_PEAKS_BIOME(VD_BIOME, true),
    STONY_SHORE_BIOME(VD_BIOME, true),
    SUNFLOWER_PLAINS_BIOME(VD_BIOME, true),
    SWAMP_BIOME(VD_BIOME, true),
    TAIGA_BIOME(VD_BIOME, true),
    WARM_OCEAN_BIOME(VD_BIOME, true),
    WINDSWEPT_FOREST_BIOME(VD_BIOME, true),
    WINDSWEPT_GRAVELLY_HILLS_BIOME(VD_BIOME, true),
    WINDSWEPT_HILLS_BIOME(VD_BIOME, true),
    WINDSWEPT_SAVANNA_BIOME(VD_BIOME, true),
    WOODED_BADLANDS_BIOME(VD_BIOME, true),
    BASALT_DELTAS_BIOME(VD_BIOME, true),
    CRIMSON_FOREST_BIOME(VD_BIOME, true),
    SOUL_SAND_VALLEY_BIOME(VD_BIOME, true),
    WARPED_FOREST_BIOME(VD_BIOME, true),
    END_BARRENS_BIOME(VD_BIOME, true),
    END_HIGHLANDS_BIOME(VD_BIOME, true),
    END_MIDLANDS_BIOME(VD_BIOME, true),
    SMALL_END_ISLANDS_BIOME(VD_BIOME, true),
