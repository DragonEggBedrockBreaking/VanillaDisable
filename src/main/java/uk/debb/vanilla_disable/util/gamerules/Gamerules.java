...
public class Gamerules {
    ...
    public static GameRules.Key<GameRules.BooleanValue> ADVANCEMENTS_ENABLED;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_ADVENTURE;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_SWEET_DREAMS;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_ADVENTURING_TIME;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_WHAT_A_DEAL;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_STAR_TRADER;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_MONSTER_HUNTER;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_MONSTERS_HUNTED;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_TAKE_AIM;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_THROWAWAY_JOKE;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_VERY_FRIGHTENING;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_HIRED_HELP;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_SNIPER_DUEL;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_POSTMORTAL;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_OLD_BETSY;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_WHOS_THE_PILLAGER_NOW;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_TWO_BIRDS_ONE_ARROW;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_ARBALISTIC;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_VOLUNTARY_EXILE;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_HERO_OF_VILLAGE;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_STICKY_SITUATION;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_BULLSEYE;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_LIGHT_AS_RABBIT;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_SURGE_PROTECTOR;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_IS_IT_A_BIRD;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_IS_IT_A_BALLOON;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_SOUND_OF_MUSIC;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_IS_IT_A_PLANE;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_CAVES_AND_CLIFFS;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_IT_SPREADS;
    public static GameRules.Key<GameRules.BooleanValue> ADVENTURE_ADVANCEMENT_SNEAK_100;
    public static GameRules.Key<GameRules.BooleanValue> HUSBANDRY_ADVANCEMENT_HUSBANDRY;
    public static GameRules.Key<GameRules.BooleanValue> HUSBANDRY_ADVANCEMENT_SEEDY_PLACE;
    public static GameRules.Key<GameRules.BooleanValue> HUSBANDRY_ADVANCEMENT_PARROTS_AND_BATS;
    public static GameRules.Key<GameRules.BooleanValue> HUSBANDRY_ADVANCEMENT_BALANCED_DIET;
    public static GameRules.Key<GameRules.BooleanValue> HUSBANDRY_ADVANCEMENT_SERIOUS_DEDICATION;
    public static GameRules.Key<GameRules.BooleanValue> HUSBANDRY_ADVANCEMENT_BEST_FRIENDS;
    public static GameRules.Key<GameRules.BooleanValue> HUSBANDRY_ADVANCEMENT_TWO_BY_TWO;
    public static GameRules.Key<GameRules.BooleanValue> HUSBANDRY_ADVANCEMENT_FISHY_BUSINESS;
    public static GameRules.Key<GameRules.BooleanValue> HUSBANDRY_ADVANCEMENT_TACTICAL_FISHING;
    public static GameRules.Key<GameRules.BooleanValue> HUSBANDRY_ADVANCEMENT_CUTEST_PREDATOR;
    public static GameRules.Key<GameRules.BooleanValue> HUSBANDRY_ADVANCEMENT_HEALING_FRIENDSHIP;
    public static GameRules.Key<GameRules.BooleanValue> HUSBANDRY_ADVANCEMENT_COMPLETE_CATALOGUE;
    public static GameRules.Key<GameRules.BooleanValue> HUSBANDRY_ADVANCEMENT_BEE_OUR_GUEST;
    public static GameRules.Key<GameRules.BooleanValue> HUSBANDRY_ADVANCEMENT_WAX_ON;
    public static GameRules.Key<GameRules.BooleanValue> HUSBANDRY_ADVANCEMENT_WAX_OFF;
    public static GameRules.Key<GameRules.BooleanValue> HUSBANDRY_ADVANCEMENT_BUKKIT;
    public static GameRules.Key<GameRules.BooleanValue> HUSBANDRY_ADVANCEMENT_SQUAD_HOPS_INTO_TOWN;
    public static GameRules.Key<GameRules.BooleanValue> HUSBANDRY_ADVANCEMENT_POWERS_COMBINED;
    public static GameRules.Key<GameRules.BooleanValue> HUSBANDRY_ADVANCEMENT_BEELOCATION;
    public static GameRules.Key<GameRules.BooleanValue> HUSBANDRY_ADVANCEMENT_FLOATS_YOUR_GOAT;
    public static GameRules.Key<GameRules.BooleanValue> HUSBANDRY_ADVANCEMENT_GLOW_AND_BEHOLD;
    public static GameRules.Key<GameRules.BooleanValue> HUSBANDRY_ADVANCEMENT_FRIEND_IN_ME;
    public static GameRules.Key<GameRules.BooleanValue> HUSBANDRY_ADVANCEMENT_BIRTHDAY_SONG;
    public static GameRules.Key<GameRules.BooleanValue> NETHER_ADVANCEMENT_NETHER;
    public static GameRules.Key<GameRules.BooleanValue> NETHER_ADVANCEMENT_RETURN_TO_SENDER;
    public static GameRules.Key<GameRules.BooleanValue> NETHER_ADVANCEMENT_TERRIBLE_FORTRESS;
    public static GameRules.Key<GameRules.BooleanValue> NETHER_ADVANCEMENT_SUBSPACE_BUBBLE;
    public static GameRules.Key<GameRules.BooleanValue> NETHER_ADVANCEMENT_UNEASY_ALLIANCE;
    public static GameRules.Key<GameRules.BooleanValue> NETHER_ADVANCEMENT_SPOOKY_SCARY_SKELETON;
    public static GameRules.Key<GameRules.BooleanValue> NETHER_ADVANCEMENT_WITHERING_HEIGHTS;
    public static GameRules.Key<GameRules.BooleanValue> NETHER_ADVANCEMENT_INTO_FIRE;
    public static GameRules.Key<GameRules.BooleanValue> NETHER_ADVANCEMENT_BRING_HOME_BEACON;
    public static GameRules.Key<GameRules.BooleanValue> NETHER_ADVANCEMENT_BEACONATOR;
    public static GameRules.Key<GameRules.BooleanValue> NETHER_ADVANCEMENT_LOCAL_BREWERY;
    public static GameRules.Key<GameRules.BooleanValue> NETHER_ADVANCEMENT_FURIOUS_COCKTAIL;
    public static GameRules.Key<GameRules.BooleanValue> NETHER_ADVANCEMENT_HOW_DID_WE_GET_HERE;
    public static GameRules.Key<GameRules.BooleanValue> NETHER_ADVANCEMENT_HIDDEN_IN_DEPTHS;
    public static GameRules.Key<GameRules.BooleanValue> NETHER_ADVANCEMENT_COVER_IN_DEBRIS;
    public static GameRules.Key<GameRules.BooleanValue> NETHER_ADVANCEMENT_COUNTRY_LODE;
    public static GameRules.Key<GameRules.BooleanValue> NETHER_ADVANCEMENT_CUTTING_ONIONS;
    public static GameRules.Key<GameRules.BooleanValue> NETHER_ADVANCEMENT_NOT_QUITE_NINE_LIVES;
    public static GameRules.Key<GameRules.BooleanValue> NETHER_ADVANCEMENT_BOAT_HAS_LEGS;
    public static GameRules.Key<GameRules.BooleanValue> NETHER_ADVANCEMENT_FEELS_LIKE_HOME;
    public static GameRules.Key<GameRules.BooleanValue> NETHER_ADVANCEMENT_HOT_TOURIST_DESTINATIONS;
    public static GameRules.Key<GameRules.BooleanValue> NETHER_ADVANCEMENT_THOSE_WERE_THE_DAYS;
    public static GameRules.Key<GameRules.BooleanValue> NETHER_ADVANCEMENT_WAR_PIGS;
    public static GameRules.Key<GameRules.BooleanValue> NETHER_ADVANCEMENT_OH_SHINY;
    public static GameRules.Key<GameRules.BooleanValue> STORY_ADVANCEMENT_MINECRAFT;
    public static GameRules.Key<GameRules.BooleanValue> STORY_ADVANCEMENT_STONE_AGE;
    public static GameRules.Key<GameRules.BooleanValue> STORY_ADVANCEMENT_GETTING_UPGRADE;
    public static GameRules.Key<GameRules.BooleanValue> STORY_ADVANCEMENT_ACQUIRE_HARDWARE;
    public static GameRules.Key<GameRules.BooleanValue> STORY_ADVANCEMENT_IRON_PICK;
    public static GameRules.Key<GameRules.BooleanValue> STORY_ADVANCEMENT_DIAMONDS;
    public static GameRules.Key<GameRules.BooleanValue> STORY_ADVANCEMENT_HOT_STUFF;
    public static GameRules.Key<GameRules.BooleanValue> STORY_ADVANCEMENT_SUIT_UP;
    public static GameRules.Key<GameRules.BooleanValue> STORY_ADVANCEMENT_ENCHANTER;
    public static GameRules.Key<GameRules.BooleanValue> STORY_ADVANCEMENT_ICE_BUCKET_CHALLENGE;
    public static GameRules.Key<GameRules.BooleanValue> STORY_ADVANCEMENT_NOT_TODAY_THANKS;
    public static GameRules.Key<GameRules.BooleanValue> STORY_ADVANCEMENT_COVER_WITH_DIAMONDS;
    public static GameRules.Key<GameRules.BooleanValue> STORY_ADVANCEMENT_GO_DEEPER;
    public static GameRules.Key<GameRules.BooleanValue> STORY_ADVANCEMENT_ZOMBIE_DOCTOR;
    public static GameRules.Key<GameRules.BooleanValue> STORY_ADVANCEMENT_EYE_SPY;
    public static GameRules.Key<GameRules.BooleanValue> THE_END_ADVANCEMENT_THE_END;
    public static GameRules.Key<GameRules.BooleanValue> THE_END_ADVANCEMENT_FREE_THE_END;
    public static GameRules.Key<GameRules.BooleanValue> THE_END_ADVANCEMENT_REMOTE_GETAWAY;
    public static GameRules.Key<GameRules.BooleanValue> THE_END_ADVANCEMENT_END_AGAIN;
    public static GameRules.Key<GameRules.BooleanValue> THE_END_ADVANCEMENT_CITY_AT_END;
    public static GameRules.Key<GameRules.BooleanValue> THE_END_ADVANCEMENT_YOU_NEED_MINT;
    public static GameRules.Key<GameRules.BooleanValue> THE_END_ADVANCEMENT_GREAT_VIEW;
    public static GameRules.Key<GameRules.BooleanValue> THE_END_ADVANCEMENT_SKY_IS_LIMIT;
    public static GameRules.Key<GameRules.BooleanValue> THE_END_ADVANCEMENT_NEXT_GENERATION;
