...
public class RegisterGamerules {
    public static void registerGamerules() {
        ...
        if (CaffeineConfigMixinConfigPlugin.dispenser) {
            Gamerules.DISPENSER_BONEMEALS_PLANTS = GameruleHelper.register("dispenserBonemealsPlants", GameruleCategories.VD_DISPENSER, true);
            Gamerules.DISPENSER_BUCKETS_ITEMS = GameruleHelper.register("dispenserBucketsItems", GameruleCategories.VD_DISPENSER, true);
            Gamerules.DISPENSER_EQUIPS_ARMOUR = GameruleHelper.register("dispenserEquipsArmour", GameruleCategories.VD_DISPENSER, true);
            Gamerules.DISPENSER_FILLS_BOTTLES = GameruleHelper.register("dispenserFillsBottles", GameruleCategories.VD_DISPENSER, true);
            Gamerules.DISPENSER_FILLS_RESPAWN_ANCHOR = GameruleHelper.register("dispenserFillsRespawnAnchor", GameruleCategories.VD_DISPENSER, true);
            Gamerules.DISPENSER_FIRES_PROJECTILES = GameruleHelper.register("dispenserFiresProjectiles", GameruleCategories.VD_DISPENSER, true);
            Gamerules.DISPENSER_FIRES_TRIDENTS = GameruleHelper.register("dispenserFiresTridents", GameruleCategories.VD_DISPENSER, true);
            Gamerules.DISPENSER_FLINTS_AND_STEELS = GameruleHelper.register("dispenserFlintsAndSteels", GameruleCategories.VD_DISPENSER, true);
            Gamerules.DISPENSER_LAUNCHES_FIREWORKS = GameruleHelper.register("dispenserLaunchesFireworks", GameruleCategories.VD_DISPENSER, true);
            Gamerules.DISPENSER_LAUNCHES_FIRE_CHARGES = GameruleHelper.register("dispenserLaunchesFireCharges", GameruleCategories.VD_DISPENSER, true);
            Gamerules.DISPENSER_LIGHTS_TNT = GameruleHelper.register("dispenserLightsTnt", GameruleCategories.VD_DISPENSER, true);
            Gamerules.DISPENSER_PLACES_ARMOUR_STANDS = GameruleHelper.register("dispenserPlacesArmourStands", GameruleCategories.VD_DISPENSER, true);
            Gamerules.DISPENSER_PLACES_BOATS = GameruleHelper.register("dispenserPlacesBoats", GameruleCategories.VD_DISPENSER, true);
            Gamerules.DISPENSER_PLACES_HEADS = GameruleHelper.register("dispenserPlacesHeads", GameruleCategories.VD_DISPENSER, true);
            Gamerules.DISPENSER_PLACES_MINECARTS = GameruleHelper.register("dispenserPlacesMinecarts", GameruleCategories.VD_DISPENSER, true);
            Gamerules.DISPENSER_PLACES_SHULKER_BOXES = GameruleHelper.register("dispenserPlacesShulkerBoxes", GameruleCategories.VD_DISPENSER, true);
            Gamerules.DISPENSER_SHEARS_SHEEP = GameruleHelper.register("dispenserShearsSheep", GameruleCategories.VD_DISPENSER, true);
            Gamerules.DISPENSER_SPAWNS_MOBS = GameruleHelper.register("dispenserSpawnsMobs", GameruleCategories.VD_DISPENSER, true);
            Gamerules.DISPENSER_WATERS_MUD = GameruleHelper.register("dispenserWatersMud", GameruleCategories.VD_DISPENSER, true);
            Gamerules.DISPENSER_WAXES_COPPER = GameruleHelper.register("dispenserWaxesCopper", GameruleCategories.VD_DISPENSER, true);
        }
        if (CaffeineConfigMixinConfigPlugin.arrow) {
            Gamerules.TIPPED_ARROWS_ENABLED = GameruleHelper.register("tippedArrowsEnabled", GameruleCategories.VD_ARROW, true);
            Gamerules.FIRE_RESISTANCE_TIPPED_ARROW = GameruleHelper.register("fireResistanceTippedArrow", GameruleCategories.VD_ARROW, true);
            Gamerules.HARMING_TIPPED_ARROW = GameruleHelper.register("harmingTippedArrow", GameruleCategories.VD_ARROW, true);
            Gamerules.HEALING_TIPPED_ARROW = GameruleHelper.register("healingTippedArrow", GameruleCategories.VD_ARROW, true);
            Gamerules.INVISIBILITY_TIPPED_ARROW = GameruleHelper.register("invisibilityTippedArrow", GameruleCategories.VD_ARROW, true);
            Gamerules.LEAPING_TIPPED_ARROW = GameruleHelper.register("leapingTippedArrow", GameruleCategories.VD_ARROW, true);
            Gamerules.LUCK_TIPPED_ARROW = GameruleHelper.register("luckTippedArrow", GameruleCategories.VD_ARROW, true);
            Gamerules.NIGHT_VISION_TIPPED_ARROW = GameruleHelper.register("nightVisionTippedArrow", GameruleCategories.VD_ARROW, true);
            Gamerules.POISON_TIPPED_ARROW = GameruleHelper.register("poisonTippedArrow", GameruleCategories.VD_ARROW, true);
            Gamerules.REGENERATION_TIPPED_ARROW = GameruleHelper.register("regenerationTippedArrow", GameruleCategories.VD_ARROW, true);
            Gamerules.SLOW_FALLING_TIPPED_ARROW = GameruleHelper.register("slowFallingTippedArrow", GameruleCategories.VD_ARROW, true);
            Gamerules.SLOWNESS_TIPPED_ARROW = GameruleHelper.register("slownessTippedArrow", GameruleCategories.VD_ARROW, true);
            Gamerules.STRENGTH_TIPPED_ARROW = GameruleHelper.register("strengthTippedArrow", GameruleCategories.VD_ARROW, true);
            Gamerules.SWIFTNESS_TIPPED_ARROW = GameruleHelper.register("swiftnessTippedArrow", GameruleCategories.VD_ARROW, true);
            Gamerules.TURTLE_MASTER_TIPPED_ARROW = GameruleHelper.register("turtleMasterTippedArrow", GameruleCategories.VD_ARROW, true);
            Gamerules.WATER_BREATHING_TIPPED_ARROW = GameruleHelper.register("waterBreathingTippedArrow", GameruleCategories.VD_ARROW, true);
            Gamerules.WEAKNESS_TIPPED_ARROW = GameruleHelper.register("weaknessTippedArrow", GameruleCategories.VD_ARROW, true);
            Gamerules.SPECTRAL_ARROWS_ENABLED = GameruleHelper.register("spectralArrowsEnabled", GameruleCategories.VD_ARROW, true);
        }
        if (CaffeineConfigMixinConfigPlugin.advancement) {
            Gamerules.ADVANCEMENTS_ENABLED = GameruleHelper.register("advancementsEnabled", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_ADVENTURE = GameruleHelper.register("adventureAdvancementAdventure", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_SWEET_DREAMS = GameruleHelper.register("adventureAdvancementSweetDreams", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_ADVENTURING_TIME = GameruleHelper.register("adventureAdvancementAdventuringTime", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_WHAT_A_DEAL = GameruleHelper.register("adventureAdvancementWhatADeal", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_STAR_TRADER = GameruleHelper.register("adventureAdvancementStarTrader", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_MONSTER_HUNTER = GameruleHelper.register("adventureAdvancementMonsterHunter", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_MONSTERS_HUNTED = GameruleHelper.register("adventureAdvancementMonstersHunted", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_TAKE_AIM = GameruleHelper.register("adventureAdvancementTakeAim", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_THROWAWAY_JOKE = GameruleHelper.register("adventureAdvancementThrowawayJoke", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_VERY_FRIGHTENING = GameruleHelper.register("adventureAdvancementVeryFrightening", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_HIRED_HELP = GameruleHelper.register("adventureAdvancementHiredHelp", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_SNIPER_DUEL = GameruleHelper.register("adventureAdvancementSniperDuel", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_POSTMORTAL = GameruleHelper.register("adventureAdvancementPostmortal", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_OLD_BETSY = GameruleHelper.register("adventureAdvancementOldBetsy", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_WHOS_THE_PILLAGER_NOW = GameruleHelper.register("adventureAdvancementWhosThePillagerNow", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_TWO_BIRDS_ONE_ARROW = GameruleHelper.register("adventureAdvancementTwoBirdsOneArrow", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_ARBALISTIC = GameruleHelper.register("adventureAdvancementArbalistic", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_VOLUNTARY_EXILE = GameruleHelper.register("adventureAdvancementVoluntaryExile", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_HERO_OF_VILLAGE = GameruleHelper.register("adventureAdvancementHeroOfVillage", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_STICKY_SITUATION = GameruleHelper.register("adventureAdvancementStickySituation", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_BULLSEYE = GameruleHelper.register("adventureAdvancementBullseye", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_LIGHT_AS_RABBIT = GameruleHelper.register("adventureAdvancementLightAsRabbit", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_SURGE_PROTECTOR = GameruleHelper.register("adventureAdvancementSurgeProtector", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_IS_IT_A_BIRD = GameruleHelper.register("adventureAdvancementIsItABird", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_IS_IT_A_BALLOON = GameruleHelper.register("adventureAdvancementIsItABalloon", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_SOUND_OF_MUSIC = GameruleHelper.register("adventureAdvancementSoundOfMusic", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_IS_IT_A_PLANE = GameruleHelper.register("adventureAdvancementIsItAPlane", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_CAVES_AND_CLIFFS = GameruleHelper.register("adventureAdvancementCavesAndCliffs", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_IT_SPREADS = GameruleHelper.register("adventureAdvancementItSpreads", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.ADVENTURE_ADVANCEMENT_SNEAK_100 = GameruleHelper.register("adventureAdvancementSneak100", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.HUSBANDRY_ADVANCEMENT_HUSBANDRY = GameruleHelper.register("husbandryAdvancementHusbandry", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.HUSBANDRY_ADVANCEMENT_SEEDY_PLACE = GameruleHelper.register("husbandryAdvancementSeedyPlace", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.HUSBANDRY_ADVANCEMENT_PARROTS_AND_BATS = GameruleHelper.register("husbandryAdvancementParrotsAndBats", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.HUSBANDRY_ADVANCEMENT_BALANCED_DIET = GameruleHelper.register("husbandryAdvancementBalancedDiet", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.HUSBANDRY_ADVANCEMENT_SERIOUS_DEDICATION = GameruleHelper.register("husbandryAdvancementSeriousDedication", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.HUSBANDRY_ADVANCEMENT_BEST_FRIENDS = GameruleHelper.register("husbandryAdvancementBestFriends", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.HUSBANDRY_ADVANCEMENT_TWO_BY_TWO = GameruleHelper.register("husbandryAdvancementTwoByTwo", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.HUSBANDRY_ADVANCEMENT_FISHY_BUSINESS = GameruleHelper.register("husbandryAdvancementFishyBusiness", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.HUSBANDRY_ADVANCEMENT_TACTICAL_FISHING = GameruleHelper.register("husbandryAdvancementTacticalFishing", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.HUSBANDRY_ADVANCEMENT_CUTEST_PREDATOR = GameruleHelper.register("husbandryAdvancementCutestPredator", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.HUSBANDRY_ADVANCEMENT_HEALING_FRIENDSHIP = GameruleHelper.register("husbandryAdvancementHealingFriendship", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.HUSBANDRY_ADVANCEMENT_COMPLETE_CATALOGUE = GameruleHelper.register("husbandryAdvancementCompleteCatalogue", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.HUSBANDRY_ADVANCEMENT_BEE_OUR_GUEST = GameruleHelper.register("husbandryAdvancementBeeOurGuest", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.HUSBANDRY_ADVANCEMENT_WAX_ON = GameruleHelper.register("husbandryAdvancementWaxOn", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.HUSBANDRY_ADVANCEMENT_WAX_OFF = GameruleHelper.register("husbandryAdvancementWaxOff", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.HUSBANDRY_ADVANCEMENT_BUKKIT = GameruleHelper.register("husbandryAdvancementBukkit", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.HUSBANDRY_ADVANCEMENT_SQUAD_HOPS_INTO_TOWN = GameruleHelper.register("husbandryAdvancementSquadHopsIntoTown", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.HUSBANDRY_ADVANCEMENT_POWERS_COMBINED = GameruleHelper.register("husbandryAdvancementPowersCombined", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.HUSBANDRY_ADVANCEMENT_BEELOCATION = GameruleHelper.register("husbandryAdvancementBeelocation", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.HUSBANDRY_ADVANCEMENT_FLOATS_YOUR_GOAT = GameruleHelper.register("husbandryAdvancementFloatsYourGoat", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.HUSBANDRY_ADVANCEMENT_GLOW_AND_BEHOLD = GameruleHelper.register("husbandryAdvancementGlowAndBehold", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.HUSBANDRY_ADVANCEMENT_FRIEND_IN_ME = GameruleHelper.register("husbandryAdvancementFriendInMe", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.HUSBANDRY_ADVANCEMENT_BIRTHDAY_SONG = GameruleHelper.register("husbandryAdvancementBirthdaySong", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.NETHER_ADVANCEMENT_NETHER = GameruleHelper.register("netherAdvancementNether", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.NETHER_ADVANCEMENT_RETURN_TO_SENDER = GameruleHelper.register("netherAdvancementReturnToSender", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.NETHER_ADVANCEMENT_TERRIBLE_FORTRESS = GameruleHelper.register("netherAdvancementTerribleFortress", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.NETHER_ADVANCEMENT_SUBSPACE_BUBBLE = GameruleHelper.register("netherAdvancementSubspaceBubble", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.NETHER_ADVANCEMENT_UNEASY_ALLIANCE = GameruleHelper.register("netherAdvancementUneasyAlliance", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.NETHER_ADVANCEMENT_SPOOKY_SCARY_SKELETON = GameruleHelper.register("netherAdvancementSpookyScarySkeleton", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.NETHER_ADVANCEMENT_WITHERING_HEIGHTS = GameruleHelper.register("netherAdvancementWitheringHeights", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.NETHER_ADVANCEMENT_INTO_FIRE = GameruleHelper.register("netherAdvancementIntoFire", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.NETHER_ADVANCEMENT_BRING_HOME_BEACON = GameruleHelper.register("netherAdvancementBringHomeBeacon", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.NETHER_ADVANCEMENT_BEACONATOR = GameruleHelper.register("netherAdvancementBeaconator", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.NETHER_ADVANCEMENT_LOCAL_BREWERY = GameruleHelper.register("netherAdvancementLocalBrewery", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.NETHER_ADVANCEMENT_FURIOUS_COCKTAIL = GameruleHelper.register("netherAdvancementFuriousCocktail", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.NETHER_ADVANCEMENT_HOW_DID_WE_GET_HERE = GameruleHelper.register("netherAdvancementHowDidWeGetHere", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.NETHER_ADVANCEMENT_HIDDEN_IN_DEPTHS = GameruleHelper.register("netherAdvancementHiddenInDepths", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.NETHER_ADVANCEMENT_COVER_IN_DEBRIS = GameruleHelper.register("netherAdvancementCoverInDebris", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.NETHER_ADVANCEMENT_COUNTRY_LODE = GameruleHelper.register("netherAdvancementCountryLode", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.NETHER_ADVANCEMENT_CUTTING_ONIONS = GameruleHelper.register("netherAdvancementCuttingOnions", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.NETHER_ADVANCEMENT_NOT_QUITE_NINE_LIVES = GameruleHelper.register("netherAdvancementNotQuiteNineLives", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.NETHER_ADVANCEMENT_BOAT_HAS_LEGS = GameruleHelper.register("netherAdvancementBoatHasLegs", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.NETHER_ADVANCEMENT_FEELS_LIKE_HOME = GameruleHelper.register("netherAdvancementFeelsLikeHome", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.NETHER_ADVANCEMENT_HOT_TOURIST_DESTINATIONS = GameruleHelper.register("netherAdvancementHotTouristDestinations", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.NETHER_ADVANCEMENT_THOSE_WERE_THE_DAYS = GameruleHelper.register("netherAdvancementThoseWereTheDays", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.NETHER_ADVANCEMENT_WAR_PIGS = GameruleHelper.register("netherAdvancementWarPigs", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.NETHER_ADVANCEMENT_OH_SHINY = GameruleHelper.register("netherAdvancementOhShiny", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.STORY_ADVANCEMENT_MINECRAFT = GameruleHelper.register("storyAdvancementMinecraft", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.STORY_ADVANCEMENT_STONE_AGE = GameruleHelper.register("storyAdvancementStoneAge", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.STORY_ADVANCEMENT_GETTING_UPGRADE = GameruleHelper.register("storyAdvancementGettingUpgrade", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.STORY_ADVANCEMENT_ACQUIRE_HARDWARE = GameruleHelper.register("storyAdvancementAcquireHardware", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.STORY_ADVANCEMENT_IRON_PICK = GameruleHelper.register("storyAdvancementIronPick", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.STORY_ADVANCEMENT_DIAMONDS = GameruleHelper.register("storyAdvancementDiamonds", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.STORY_ADVANCEMENT_HOT_STUFF = GameruleHelper.register("storyAdvancementHotStuff", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.STORY_ADVANCEMENT_SUIT_UP = GameruleHelper.register("storyAdvancementSuitUp", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.STORY_ADVANCEMENT_ENCHANTER = GameruleHelper.register("storyAdvancementEnchanter", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.STORY_ADVANCEMENT_ICE_BUCKET_CHALLENGE = GameruleHelper.register("storyAdvancementIceBucketChallenge", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.STORY_ADVANCEMENT_NOT_TODAY_THANKS = GameruleHelper.register("storyAdvancementNotTodayThanks", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.STORY_ADVANCEMENT_COVER_WITH_DIAMONDS = GameruleHelper.register("storyAdvancementCoverWithDiamonds", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.STORY_ADVANCEMENT_GO_DEEPER = GameruleHelper.register("storyAdvancementGoDeeper", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.STORY_ADVANCEMENT_ZOMBIE_DOCTOR = GameruleHelper.register("storyAdvancementZombieDoctor", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.STORY_ADVANCEMENT_EYE_SPY = GameruleHelper.register("storyAdvancementEyeSpy", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.THE_END_ADVANCEMENT_THE_END = GameruleHelper.register("theEndAdvancementTheEnd", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.THE_END_ADVANCEMENT_FREE_THE_END = GameruleHelper.register("theEndAdvancementFreeTheEnd", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.THE_END_ADVANCEMENT_REMOTE_GETAWAY = GameruleHelper.register("theEndAdvancementRemoteGetaway", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.THE_END_ADVANCEMENT_END_AGAIN = GameruleHelper.register("theEndAdvancementEndAgain", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.THE_END_ADVANCEMENT_CITY_AT_END = GameruleHelper.register("theEndAdvancementCityAtEnd", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.THE_END_ADVANCEMENT_YOU_NEED_MINT = GameruleHelper.register("theEndAdvancementYouNeedMint", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.THE_END_ADVANCEMENT_GREAT_VIEW = GameruleHelper.register("theEndAdvancementGreatView", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.THE_END_ADVANCEMENT_SKY_IS_LIMIT = GameruleHelper.register("theEndAdvancementSkyIsLimit", GameruleCategories.VD_ADVANCEMENT, true);
            Gamerules.THE_END_ADVANCEMENT_NEXT_GENERATION = GameruleHelper.register("theEndAdvancementNextGeneration", GameruleCategories.VD_ADVANCEMENT, true);
        }
