...
public enum IntegerGamerules {
    ...
    DEFAULT_BLOCK_FRICTION(VD_BLOCKS, 60),
    ICE_FRICTION(VD_BLOCKS, 98),
    SLIME_FRICTION(VD_BLOCKS, 80),
    DEFAULT_BLOCK_SPEED(VD_BLOCKS, 100),
    SOUL_SAND_SPEED(VD_BLOCKS, 40),
    HONEY_BLOCK_SPEED(VD_BLOCKS, 40),
    DEFAULT_BLOCK_JUMP(VD_BLOCKS, 100),
    HONEY_BLOCK_JUMP(VD_BLOCKS, 50),
