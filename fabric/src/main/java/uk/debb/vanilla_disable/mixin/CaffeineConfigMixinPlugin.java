...
public class CaffeineConfigMixinPlugin extends AbstractCaffeineConfigMixinPlugin {
    ...
    protected CaffeineConfig createConfig() {
        caffeineConfig = CaffeineConfig.builder("VanillaDisable")
                ...
                .addMixinOption("util", true, false)
                .addMixinOption("util.command", true, false)
                .addMixinOption("util.gamerule", true, false)
                .addMixinOption("util.worldgen", true, false)
                ...
                .addOptionDependency("util.command", "command", true)
                .addOptionDependency("util.gamerule", "gamerule", true)
                .addOptionDependency("util.worldgen", "worldgen", true)
